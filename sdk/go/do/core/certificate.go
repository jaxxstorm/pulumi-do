...
func NewCertificate(ctx *pulumi.Context,
	...
	inputs["state"] = nil
	s, err := ctx.RegisterResource("do:core/certificate:Certificate", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetCertificate(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("do:core/certificate:Certificate", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &Certificate{s: s}, nil
