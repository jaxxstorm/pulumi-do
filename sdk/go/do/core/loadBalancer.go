...
func NewLoadBalancer(ctx *pulumi.Context,
	...
	inputs["ip"] = nil
	inputs["status"] = nil
	s, err := ctx.RegisterResource("do:core/loadBalancer:LoadBalancer", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetLoadBalancer(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("do:core/loadBalancer:LoadBalancer", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &LoadBalancer{s: s}, nil
