...
export class Droplet extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DropletState): Droplet {
        return new Droplet(name, <any>state, { id });
    }
    ...
    constructor(name: string, argsOrState?: DropletArgs | DropletState, opts?: pulumi.CustomResourceOptions) {
        ...
        super("do:core/droplet:Droplet", name, inputs, opts);
    }
}
